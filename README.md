...
La pipeline GitHub Actions se déclenche automatiquement à chaque push sur main.
...
La pipeline se lance automatiquement et envoie une notification Google Chat.
